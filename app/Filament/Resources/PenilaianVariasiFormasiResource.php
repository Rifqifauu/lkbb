...
use App\Filament\Resources\PenilaianVariasiFormasiResource\RelationManagers;
...
class PenilaianVariasiFormasiResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Penilaian Variasi Formasi';
    protected static ?string $modelLabel = 'Penilaian Variasi Formasi';
    protected static ?string $pluralModelLabel = 'Penilaian Variasi Formasi';
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Repeater::make('penilaian_items')
                ...
                ->schema([
                    ...
                    Select::make('nilai')
                        ...
                        ->options(function (callable $get) {
                            ...
                            $aspek = AspekVariasiFormasi::find($aspekId);
                            if (!$aspek) {
                                return [];
                            }
                ...
                ->collapsible()
                ->default(function () {
                    return AspekVariasiFormasi::all()->map(fn ($aspek) => [
                        'id_aspek' => $aspek->id,
...
public static function table(Table $table): Table
{
    ...
    foreach (AspekVariasiFormasi::all() as $aspek) {
        $columns[] = Tables\Columns\TextColumn::make("aspek_{$aspek->id}")
            ...
            ->getStateUsing(function ($record) use ($aspek) {
                ...
                $penilaian = PenilaianVariasiFormasi::where('id_peserta', $record->id_peserta)
    ...
    return $table
        ->query(
            ...
            PenilaianVariasiFormasi::with(['peserta', 'penilai', 'aspek'])
                ->orderBy('id_peserta')
                ->orderBy('id_user')
        )

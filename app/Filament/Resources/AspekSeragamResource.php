...
use App\Filament\Resources\AspekSeragamResource\Pages;
use App\Filament\Resources\AspekSeragamResource\RelationManagers;
...
class AspekSeragamResource extends Resource
{
    protected static ?string $model = AspekSeragam::class;
    ...
    public static function form(Form $form): Form
{
    ...
    {
        return [
            'index' => Pages\ListAspekSeragams::route('/'),
            'create' => Pages\CreateAspekSeragam::route('/create'),
            'edit' => Pages\EditAspekSeragam::route('/{record}/edit'),
        ];
    }
}
